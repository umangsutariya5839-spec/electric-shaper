...
export default async function AdminDashboard() {
  ...
  return (
    <div>
      <h1 style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '0.5rem' }}>Shop Owner Dashboard</h1>
      <p style={{ color: 'var(--color-text-muted)', marginBottom: '2rem' }}>Manage your incoming leads and business performance.</p>
